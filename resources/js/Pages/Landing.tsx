...
const TrackIcon: React.FC = () => (
    <svg className="h-7 w-7 text-amber-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
const Landing: React.FC<LandingProps> = ({ stats, plans }) => {
    return (
        <PublicLayout>
            ...
            {/* Hero */}
            <section className="bg-white pt-24 pb-20 text-center px-4">
                <div className="mx-auto max-w-3xl">
                    <h1 className="text-5xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                        Stop guessing.{' '}
                        <span className="text-amber-500">Build what's missing.</span>
                    </h1>
                    ...
                    <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a
                            href="/register"
                            className="inline-flex items-center justify-center rounded-lg bg-amber-500 hover:bg-amber-600 px-8 py-3 text-base font-semibold text-white border border-amber-500 hover:border-amber-600 transition-colors duration-150"
                        >
                            Start free trial
                        </a>
                    </div>
                ...
                <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 text-center">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-500">Apps tracked</p>
                        </div>
                        <div>
                            <p className="text-3xl font-bold text-gray-900">
                                {formatNumber(stats.stores_count)}
                            </p>
                            <p className="mt-1 text-sm text-gray-500">Stores indexed</p>
                        </div>
                        <div>
                            <p className="text-3xl font-bold text-gray-900">
                                {formatNumber(stats.reviews_count)}
                            </p>
                            <p className="mt-1 text-sm text-gray-500">Reviews analyzed</p>
                        </div>
                        <div>
                            <p className="text-3xl font-bold text-gray-900">24h</p>
                            <p className="mt-1 text-sm text-gray-500">AI insight SLA</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            {/* How it works */}
            <section id="how-it-works" className="bg-gray-50 border-y border-gray-200 py-24 px-4">
                <div className="mx-auto max-w-4xl">
                    ...
                    <div className="mt-16 grid gap-12 sm:grid-cols-3">
                        <div className="text-center">
                            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-amber-100 text-amber-600 font-bold text-lg">
                                1
                            </div>
                                ...
                                return (
                                    <div
                                        ...
                                        className={[
                                            ...
                                            isPremium
                                                ? 'border-amber-400 bg-gradient-to-b from-amber-500 to-orange-600 text-white scale-105 shadow-xl'
                                                : 'border-gray-200 bg-white text-gray-900',
                                        ].join(' ')}
                                    >
                                        {isPremium && (
                                            <span className="mb-4 inline-block self-start rounded-full bg-white/20 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-white">
                                                Most popular
                                            </span>
                                        )}
                                        <h3
                                        ...
                                        {plan.description && (
                                            <p
                                                className={[
                                                    'mt-2 text-sm',
                                                    isPremium ? 'text-amber-100' : 'text-gray-500',
                                                ].join(' ')}
                                            >
                                                {plan.description}
                                            </p>
            ...
            {/* CTA */}
            <section className="bg-gray-50 border-t border-gray-200 py-24 px-4 text-center">
